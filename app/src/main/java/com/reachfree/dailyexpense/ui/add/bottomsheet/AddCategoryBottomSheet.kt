...
class AddCategoryBottomSheet(
    ...
    private lateinit var onCategoryItemSelected: OnCategoryItemSelected

    fun setOnCategoryItemSelected(onCategoryItemSelected: OnCategoryItemSelected) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerCategory.apply {
            ...
            addCategoryAdapter.submitList(categories)
        }

        addCategoryAdapter.setOnItemClickListener { category ->
            onCategoryItemSelected.onSelectedCategory(category)
            dismiss()
        }
    }
